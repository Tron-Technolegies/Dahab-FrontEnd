    ...
    <div className="px-5 md:px-10 lg:px-[120px] xl:px-[180px] py-16 sm:py-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto sm:p-10">
          <motion.div
            className="bg-[#060E23] rounded-xl p-6 sm:p-8 lg:p-10 text-center"
            initial={{
              borderImageSource:
          ...
          >
            ...
            <div className="space-y-4 text-sm sm:text-base lg:text-md text-gray-300 leading-relaxed mb-8">
              <p>
                ...
                designed to open up this opportunity to newcomers and veterans alike – whether
                you're a student, a home investor, or a business, you can plug into the profit
                potential of mining without running into the usual roadblocks.
              </p>
              ...
              <p>
                ...
                need technical expertise or a warehouse of equipment to start mining with us – just
                a desire to earn crypto. We believe crypto mining should be as accessible as
                possible, and our Digital Miner program is built to deliver exactly that.
              </p>
            </div>

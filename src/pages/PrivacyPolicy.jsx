...
//         </p>
//         <p>
//           Dahab Miners Electrical Contracting LLC ("Dahab Miners," "we," "us,"
//           or "our") is committed to protecting your privacy. This Privacy Policy
//           explains how we collect, use, disclose, and safeguard your information
//           when you visit our website, purchase our products, or use our services
//         </p>
...
//           <li>
//             Name, email address, phone number, and billing/shipping address when
//             you purchase a miner, request hosting, or contact us.
//           </li>
//           <li>
//             Payment details for transactions (we do not store full card or
//             banking details, but process payments through secure third-party
//             providers).
//           </li>
//           <li>
//             Government-issued IDs if required for agreements (e.g., hosting
//             contracts, warranties, or compliance purposes).
//           </li>
//         </ul>
//         <h4 className="text-2xl font-semibold">
//           1.2 Transaction and Service Information:
//         </h4>
//         <ul className="font-light ms-10">
//           <li>Details about purchases, invoices, and service requests.</li>
//           <li>
//             Hosting service agreements, including contract duration and service
//             terms.
//           </li>
//           <li>
//             Repair requests, including miner specifications, issue reports, and
//             warranty claims.
//           </li>
//         </ul>
//         <h4 className="text-2xl font-semibold">
...
//         <ul className="font-light ms-10">
//           <li>
//             IP address, device information, and browsing activity when
//             interacting with our website.
//           </li>
//           <li>
//             Cookies and analytics data to improve website performance and user
//             experience.
//           </li>
//         </ul>
//         <h4 className="text-2xl font-semibold">
...
//         <ul className="font-light ms-10">
//           <li>
//             Process and fulfill orders for mining machines and hosting services.
//           </li>
//           <li>Provide customer support and service assistance.</li>
//           <li>
//             Manage contracts, including hosting agreements and repair
//             warranties.
//           </li>
...
//         <ul className="font-light ms-10">
//           <li>
//             We accept cryptocurrency and bank transfers as payment methods.
//           </li>
//           <li>
//             Hosting in UAE requires a deposit and hosting advance equivalent to
//             one month’s hosting fee.
//           </li>
//           <li>Hosting in Ethiopia does not require an advance payment.</li>
//           <li>
//             All transactions are securely processed through reputable payment
...
//             vendors assisting in payment processing, delivery, or IT support.
//           </li>
//           <li>
//             <span className="font-medium">Legal compliance:</span> When required
//             by UAE laws or regulatory authorities.
//           </li>
//           <li>
//             <span className="font-medium">Contractual obligations:</span> If
//             part of a hosting or repair contract, where documentation is
//             necessary.
//           </li>
//         </ul>
//         <h4 className="text-2xl font-semibold">
...
//         <ul className="font-light ms-10">
//           <li>
//             We retain customer data for the duration of active contracts plus
//             five years for legal, tax, and warranty purposes.
//           </li>
//           <li>
//             Technical measures, including encryption, firewalls, and secure
//             storage, are in place to prevent unauthorized access.
//           </li>
//         </ul>

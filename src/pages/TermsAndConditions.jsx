    ...
    <div className="px-5 md:px-10 lg:px-[120px] xl:px-[180px] py-5">
      ...
      <div className="flex flex-col gap-5">
        ...
        <p>
          ...
          you (“Client,” “you,” or “your”) agree to comply with and be bound by
        ...
        <ul className="font-light ms-10">
          ...
          <li>
            Free configuration assistance for customers setting up their miners
          </li>
        </ul>
        ...
        <ul className="ms-10">
          ...
          <li>
            <span className="font-medium">Minimum Hosting Period:</span> 2 years
          ...
          <li>
            <span className="font-medium">Dahab Miners’ Responsibilities:</span>{" "}
        ...
        <ul className="font-light ms-10">
          <li>
            Clients may terminate their hosting agreement with 30 days’ written
            notice.
          </li>
          <li>
            Dahab Miners reserves the right to terminate services with 30 days'
        ...
        <h4 className="text-2xl font-semibold">11. Limitation of Liability</h4>
        <ul className="font-light ms-10">
          <li>
            Dahab Miners is not responsible for market fluctuations, mining
            profitability, or external factors affecting cryptocurrency prices.
          </li>
          <li>
          ...
          <li>
            Liability for any repair-related damages is covered for a maximum of
            one week after service completion.
          </li>
        </ul>
        ...
        <ul className="font-light ms-10">
          ...
          <li>
            Any legal disputes shall be settled within Abu Dhabi’s jurisdiction.
          </li>
        </ul>
        <h4 className="text-2xl font-semibold">13. Termination of Agreement</h4>
        <ul className="font-light ms-10">
          <li>
            Clients may terminate this contract with 30 days' written notice.
          </li>
          <li>
            Dahab Miners reserves the right to terminate hosting agreements for
            non-payment, misuse, or breach of contract.
          </li>
          <li>
        ...
        <h4 className="text-2xl font-semibold">14. Warranty & Repair Policy</h4>
        <ul className="font-light ms-10">
        ...
        <ul className="font-light ms-10">
          <li>
            This document represents the entire agreement between the Client and
            Dahab Miners, superseding all prior discussions or negotiations.
          </li>
          <li>
